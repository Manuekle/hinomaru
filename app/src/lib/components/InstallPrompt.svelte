...
{#if showPrompt}
	<div
		use:fadeUp={{ y: 20 }}
		style="position:fixed; bottom:env(safe-area-inset-bottom, 12px); left:max(12px, env(safe-area-inset-left)); right:max(12px, env(safe-area-inset-right)); z-index:100;
